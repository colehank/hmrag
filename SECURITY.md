...
If you find a security vulnerability in hmrag, please report it through [GitHub's private vulnerability reporting](https://github.com/colehank/hmrag/security/advisories/new). This keeps the details private while we work on a fix.
